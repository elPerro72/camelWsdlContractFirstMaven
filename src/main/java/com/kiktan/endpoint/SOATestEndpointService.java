 ...
 * 2018-11-02T08:41:24.699Z
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "SOATestEndpointService",
                  wsdlLocation = "file:/projects/camelWsdlContractFirst/src/main/resources/wsdl/test.wsdl",
...
public class SOATestEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/projects/camelWsdlContractFirst/src/main/resources/wsdl/test.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SOATestEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/projects/camelWsdlContractFirst/src/main/resources/wsdl/test.wsdl");
        }
        WSDL_LOCATION = url;
    }
